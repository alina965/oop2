...
public class Database {
    ...
    public void addTable(String name, List<Column> columns) throws IllegalArgumentException {
    ...
    public void dropTable(String name) throws IllegalArgumentException {
        if (!tables.containsKey(name)) {
            throw new IllegalArgumentException("Таблицы с таким названием нет: " + name);
        }
